...
CORE_CHAINCODE_BUILDER=pesicsasa/fabric-ccenv:latest
CORE_CHAINCODE_GOLANG=pesicsasa/fabric-baseos:latest
CORE_CHAINCODE_CAR=pesicsasa/fabric-baseos:latest
CORE_CHAINCODE_JAVA=pesicsasa/fabric-javaenv::aarch64-1.1.0
